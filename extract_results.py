...
if __name__ == '__main__':
    ...
    print(Logging.s("event model names: {}".format(result_dir)))
    print(Logging.s("result directory path: {}".format(bbox_video_path)))
    print(Logging.s("bbox video path: {}".format(event_model_names)))
